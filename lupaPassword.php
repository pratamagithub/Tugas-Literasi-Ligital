          ...
          <form action="lupaPasswordAct.php" method="post" name="forgot" id="checkout-form" class="clearfix" style="padding:20px;margin:45px;float:none;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-radius: 25px">
            ...
            if (!isset($_GET['status'])) { ?>
              <div class="form-group">
                <p>Email / Telepon</p>
                <input class="input" type="text" name="emailtel" placeholder="Masukkan Email atau Telepon">
              </div>
            <?php } else if ($_GET['status'] == "terkirim") { ?>
              ...
              <div class="form-group">
                <p>Kode Verifikasi</p>
                <input class="input" type="text" name="kode" placeholder="Masukkan Kode Verifikasi">
              </div>
            ...
            <?php } else if ($_GET['status'] == "verified") { ?>
              ...
              <div class="form-group">
                <p>Password Baru</p>
                <input class="input" type="text" name="password" placeholder="Masukkan Kode Verifikasi">
              </div>
              <div class="form-group">
                <p>Konfirmasi Password Baru</p>
                <input class="input" type="text" name="password2" placeholder="Masukkan Kode Verifikasi">
              </div>
