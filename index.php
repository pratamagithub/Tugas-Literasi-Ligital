		...
		<div class="container">
			...
			<div class="row">
				...
				if (isset($_GET['kategori'])) {
					$ambil = $koneksi->query("SELECT * FROM tbl_barang WHERE id_kategoriBarang=(SELECT id_kategoriBarang FROM tbl_kategoribarang WHERE nama_kategoriBarang='" . $_GET['kategori'] . "') LIMIT $mulai, $halaman") or die("Last error: {$koneksi->error}\n");
				} else { 
					$ambil = $koneksi->query("SELECT * FROM tbl_barang LIMIT $mulai, $halaman") or die("Last error: {$koneksi->error}\n");
				}
